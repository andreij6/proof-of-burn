...
# Degen Fast Lane — enabled locally for testing; ships dark on mainnet.
icp canister call backend admin_set_feature_flag '("fast_lane", true)' -e "$ENV" --identity "$ADMIN_IDENTITY" >/dev/null
