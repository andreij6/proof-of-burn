  ...
  return (
    <div className="dashboard-container">
      ...
      <Section icon="zap" title="Lossless staking — three terms, one principal, zero loss">
        ...
        <Li>Unstake any time: the tier's neuron splits, the split dissolves for the full term, then the ICP lands back in your wallet automatically (net of ~0.0002 ICP in fees).</Li>
